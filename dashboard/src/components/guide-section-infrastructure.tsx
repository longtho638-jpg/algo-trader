    ...
    <section id="how-it-works">
      ...
      <div className="mt-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm font-mono border-collapse">
            ...
            <tbody className="divide-y divide-[#2D3142]">
              <tr><td className="py-2 pr-6 text-white">$1,000</td><td className="py-2 pr-6">$5-25</td><td className="py-2">$150-750</td></tr>
              <tr><td className="py-2 pr-6 text-white">$5,000</td><td className="py-2 pr-6">$25-100</td><td className="py-2">$750-3,000</td></tr>
            </tbody>
          </table>
        </div>
        <div className="mt-3 border-l-4 border-red-500 bg-red-500/10 px-4 py-3 rounded-r-lg">
          ...
          <p className="text-sm font-mono text-red-300 mt-1">Month 1 may LOSE $200-500 while learning. This is NOT a money printer.</p>
        </div>
      </div>
    </section>
  );
